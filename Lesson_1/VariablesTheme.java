public class VariablesTheme {
    ...
    public static void main(String[] args) {
        ...
        double sum = (bookPrice * discount) + (penPrice * discount);
        ...
        byte byteInitialValue = 127;
        short sortInitialValue = 32767;
        int integerInitialValue = 2147483647;
        long longInitialValue = 9223372036854775807L;
        System.out.println("byte первоначальное значение: " + byteInitialValue + "\nЗначение после инкремента: " + (++byteInitialValue)
         + "\nЗначение после декремента: " + (--byteInitialValue));
        System.out.println("\n" + "short первоначальное значение: " + sortInitialValue + "\nЗначение после инкремента: " + (++sortInitialValue)
         + "\nЗначение после декремента: " + (--sortInitialValue));
        System.out.println("\n" + "short первоначальное значение: " + integerInitialValue + "\nЗначение после инкремента: " + (++integerInitialValue)
         + "\nЗначение после декремента: " + (--integerInitialValue));
        System.out.println("\n" + "short первоначальное значение: " + longInitialValue + "\nЗначение после инкремента: " + (++longInitialValue)
         + "\nЗначение после декремента: " + (--longInitialValue));
        ...
        char inclinedLineRight = 47; // /
        char inclinedLineLeft = 92; // \
        char underlining = 95; // _
        System.out.println("\n"+ gap + gap + gap + gap + gap + inclinedLineRight + inclinedLineLeft
         + "\n"+ gap + gap + gap + gap + inclinedLineRight + gap + gap + inclinedLineLeft
          + "\n"+ gap + gap + gap + inclinedLineRight + underlining + leftBracket + gap + rightBracket + inclinedLineLeft
           + "\n" + gap + gap + inclinedLineRight + gap + gap + gap + gap + gap + gap + inclinedLineLeft
            + "\n" + gap + inclinedLineRight + underlining + underlining + underlining + underlining + inclinedLineRight
             + inclinedLineLeft + underlining + underlining + inclinedLineLeft);
        ...
        int total2 = 86399;
        int minutes1 = (total2 / 60) % 60;
        int hour1 = total2 / 60 / 60;
        int second1 = total2 % 60;
